...
export const BankDetailsDeleteDialog = (props: IBankDetailsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="merchantEngineApp.bankDetails.delete.question">
        <Translate contentKey="merchantEngineApp.bankDetails.delete.question" interpolate={{ id: bankDetailsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-bankDetails" color="danger" onClick={confirmDelete}>
