...
import com.fss.onboard.config.audit.AuditEventConverter;
import com.fss.onboard.domain.PersistentAuditEvent;
...
import static com.fss.onboard.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
