...
export class BankDetailsDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('merchantEngineApp.bankDetails.delete.question'));
...
export default class BankDetailsComponentsPage {
  ...
  async deleteBankDetails() {
    ...
    expect(await bankDetailsDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/merchantEngineApp.bankDetails.delete.question/);
